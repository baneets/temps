...
**Multi-node scaling** — if you need more capacity than a single server provides, you can [add worker nodes](/docs/multi-node) to distribute containers across multiple machines. The control plane schedules replicas across all active nodes using round-robin.
...
<Properties>
  ...
  <Property name="cpu_request" type="string">
    Minimum guaranteed CPU. Used for scheduling decisions.
  </Property>
  <Property name="memory_request" type="string">
