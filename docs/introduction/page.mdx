...
<Row>
  <Col>
    **Self-Hosted** - Run on your own infrastructure - Complete data ownership -
    No vendor lock-in - No usage limits
  </Col>
  <Col>
    **All-in-One** - Analytics built-in - Error tracking (Sentry-compatible) -
    Session replay - Uptime monitoring
  </Col>
</Row>
