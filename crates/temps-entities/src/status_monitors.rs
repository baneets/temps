...
#[sea_orm(table_name = "status_monitors")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
    pub project_id: i32,
...
pub enum Relation {
    ...
    Environment,
    #[sea_orm(has_many = "super::status_checks::Entity")]
    StatusChecks,
}
...
impl Related<super::status_checks::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::StatusChecks.def()
    }
}
