...
export const cliLoginMutation = (options?: Partial<Options<CliLoginData>>): UseMutationOptions<CliLoginResponse, DefaultError, Options<CliLoginData>> => {
    const mutationOptions: UseMutationOptions<CliLoginResponse, DefaultError, Options<CliLoginData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await cliLogin({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const mintGitCredentialMutation = (options?: Partial<Options<MintGitCredentialData>>): UseMutationOptions<MintGitCredentialResponse, DefaultError, Options<MintGitCredentialData>> => {
    const mutationOptions: UseMutationOptions<MintGitCredentialResponse, DefaultError, Options<MintGitCredentialData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await mintGitCredential({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
